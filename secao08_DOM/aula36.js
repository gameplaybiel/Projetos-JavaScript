...
/*
-> As configurações de estilos via JavaScript seguem os mesmos conceitos e 
   atributos utilizados via CSS.

OBS: Diferença
-> Em CSS, usa-se background-color
-> Em JavaScript usa-se backgroundColor

Outro exemplo:
Em CSS, usa-se font-size
Em JavaScript, usa-se fontSize

Mais um exemplo:
Em CSS, usa-se margin-bottom
